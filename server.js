        ...
        <html>
            ...
            <BODY>
                <div class="container">
                    ...
                    <h3>${heading}</h3>
                    <div>${date}</div>
                    <div align="left"><img src="https://en.wikipedia.org/wiki/Algemeen_Dagblad#/media/File:New_Logo_AD.jpg" alt="advertisement" width="400px" height="400px"><br><a href="1.com">ad link</a></div>
                    <div>${content}</div>
               </div>     
            </BODY>
            </html>
